...
export class SuggestionDecoratorNode extends DecoratorNode<JSX.Element> {
  ...
  static importJSON(json: SerializedLexicalNode): LexicalNode {
    const jsonData = json.$ as { suggestion: AISuggestion }
    const node = new SuggestionDecoratorNode(jsonData.suggestion)
    return node
  }
...
//   const debouncedSuggestions = useDebounce(suggestions, 100)
//   useEffect(() => {
//     editor.update(() => {
//       const root = $getRoot()
...
//       debouncedSuggestions.forEach((suggestion) => {
